Start-Transcript -Path "C:\tinysocs\tinysocs\logs\setup-20251021-010323.log" -Append | Out-Null
try {
  ...
  $global:TinySOCS_LogPath = "C:\tinysocs\tinysocs\logs\setup-20251021-010323.log"
